...
namespace Application.UnitTest.Features.ProductTest.UpdateProductTest
{
    public class UpdateProductCommandHandlerTests
    {
        ...
        public async Task Handle_ShouldUpdateProduct_WhenProductExists()
        {
            ...
            var command = new UpdateProductCommand
            {
                ...
                CategoryId = 1,
                Quantity = 10,
                Files = new List<ImageFileRequestModel>
                {
                    new ImageFileRequestModel { File = new Mock<IFormFile>().Object, OrderNumber = 1 }
                }
            };
